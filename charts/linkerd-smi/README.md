...
| adaptor.resources.cpu.limit | string | `""` | Maximum amount of CPU units that the proxy can use |
| adaptor.resources.cpu.request | string | `""` | Amount of CPU units that the proxy requests |
| adaptor.resources.ephemeral-storage.limit | string | `""` | Maximum amount of ephemeral storage that the proxy can use |
| adaptor.resources.ephemeral-storage.request | string | `""` | Amount of ephemeral storage that the proxy requests |
| adaptor.resources.memory.limit | string | `""` | Maximum amount of memory that the proxy can use |
| adaptor.resources.memory.request | string | `""` | Maximum amount of memory that the proxy requests |
